...
GitHub Issue: #97.
Status: **PR [2b/4] COMPLETE** (2026-05-24) — OBD UI lane live at `/goldens/obd`.  PR series rescoped 3→4 PRs after the post-[1/3] discussion (see v1.5.3 of `v2_design_doc.md`).  PR [3/4] (baseline scorecard + prompt iteration + eval-reader migration v1→v2/locked) remains.  Design doc: `docs/plans/2026-05-17-harness-21-obd-eval-design.md`.
