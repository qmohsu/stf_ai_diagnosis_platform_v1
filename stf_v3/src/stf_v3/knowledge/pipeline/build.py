...
Usage (build host, e.g. inside ``~/bakeoff`` venv on the server):
    ...
    python -m stf_v3.knowledge.pipeline.build \\
        --pdf tricity155.pdf \\
...
from stf_v3.knowledge.pipeline.audit import (
    gate_or_raise,
    reconcile,
    write_build_report,
)
from stf_v3.knowledge.pipeline.authority import TextAuthority
from stf_v3.knowledge.pipeline.compose import compose
