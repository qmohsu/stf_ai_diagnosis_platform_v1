...
Usage (build host):
    ...
    PYTHONPATH=. python -m stf_v3.knowledge.pipeline.index_build \\
...
from stf_v3.knowledge.pipeline.entities import (
    build_fault_entities,
    sweep_codes,
)
from stf_v3.knowledge.pipeline.index_schema import ManualIndex, Vocab
from stf_v3.knowledge.pipeline.invariants import validate
from stf_v3.knowledge.pipeline.stream import load_mineru_stream
from stf_v3.knowledge.pipeline.summarize import (
    enrich_summaries,
    summary_conforms,
)
from stf_v3.knowledge.pipeline.tree_builder import build_tree
