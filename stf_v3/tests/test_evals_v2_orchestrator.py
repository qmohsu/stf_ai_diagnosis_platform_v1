# Copied from diagnostic_api/tests/harness/evals/test_orchestrator.py @ 9c9e7a9
# (PROD-10): the V2 orchestrator contract still holds for the V3 copy.
...
def test_run_pipeline_sync_wrapper(monkeypatch) -> None:  # noqa: ANN001
    ...
    import stf_v3.evals.orchestrator as orch
